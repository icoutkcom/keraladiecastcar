        ...
        <form onSubmit={handleSearch} className="glass-card rounded-2xl p-6">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search by brand, model, scale, or category..."
                className="pl-12 h-14 text-lg glass border-white/20 text-white placeholder:text-gray-400"
                value={searchQuery}
            ...
            <div className="flex gap-3">
              <Button
                variant="ghost"
                size="lg"
                className="glass border-white/20 text-white hover:bg-white/10 h-14 px-6"
              >
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            ...
            {['Ferrari', 'Lamborghini', '1:18 Scale', 'BMW', 'Mercedes'].map((tag) => (
              <button
                key={tag}
                onClick={() => {
                  setSearchQuery(tag);
